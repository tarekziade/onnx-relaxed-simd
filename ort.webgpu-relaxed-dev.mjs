  ...
  "web/lib/wasm/wasm-utils-import.ts"() {
    ...
    importWasmModule = async (urlOverride, prefixOverride, isMultiThreaded) => {
      if (false) {
        ...
        const wasmModuleFilename = false ? "ort-training-wasm-relaxedsimd-threaded.mjs" : true ? "ort-wasm-relaxedsimd-threaded.jsep.mjs" : "ort-wasm-relaxedsimd-threaded.mjs";
        //const wasmModuleUrl = urlOverride ?? normalizeUrl(wasmModuleFilename, prefixOverride);
        const wasmModuleUrl = `./${wasmModuleFilename}`;
