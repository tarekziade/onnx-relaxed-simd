  ...
  "web/lib/wasm/wasm-utils-import.ts"() {
    ...
    importWasmModule = async (urlOverride, prefixOverride, isMultiThreaded) => {
      if (false) {
        ...
        const wasmModuleFilename = false ? "ort-training-wasm-simd-threaded-baseline.mjs" : true ? "ort-wasm-simd-threaded-baseline.jsep.mjs" : "ort-wasm-simd-threaded-baseline.mjs";
